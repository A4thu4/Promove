        ...
        if submitted:
            ...
            try:
                with st.spinner("Calculando..."):
                    ...
                    if not df:
                        st.error("Erro: o processamento da planilha não retornou dados. Verifique o conteúdo da planilha e as colunas obrigatórias.")
                    ...
                    diagnostico_obrigatorios = df[4] if len(df) > 4 else None
